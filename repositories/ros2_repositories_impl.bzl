...
def ros2_repositories_impl():
    ...
    maybe(
        ...
        patches = ["@com_github_mvukov_rules_ros2//repositories/patches:ros2cli_replace-netifaces.patch","@com_github_mvukov_rules_ros2//repositories/patches:ros2cli_init.patch"],
