...
"""
        self._check('xacro/test_urdf/model.urdf', expected_xml)
...
"""
        self._check('xacro/test_include/model.urdf', expected_xml)
...
"""
        self._check('xacro/test_with_params/model.urdf', expected_xml)
